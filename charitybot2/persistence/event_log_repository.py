...
class EventLogDoesNotExistException(Exception):
    pass
...
class EventLogRepository(SQLiteRepository):
    ...
    def event_log_exists(self, event_identifier):
        return None
    ...
    def add_event_log(self, event_identifier, timestamp=None):
        return None

    def update_event_log(self, event_identifier, timestamp):
        return None

    def get_event_log_timestamp(self, event_identifier):
        return None
